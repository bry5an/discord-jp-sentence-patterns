...
class VocabCog(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if not patterns:
            await processing_msg.edit(
                content="✅ Added, but no grammar patterns found for generation."
            )
            return
    ...
    async def remove_vocab(self, ctx, *, word: str):
        ...
        if phrases:
            ...
            embed.add_field(
                name="Sentences to be deleted:", value=preview_text, inline=False
            )
        ...
        try:
            ...
            await confirmation_msg.edit(
                content="❌ Deletion cancelled (timed out).", embed=None
            )
        ...
        try:
            ...
            await confirmation_msg.edit(
                content=f"✅ Successfully deleted **{word}** and {phrase_count} sentences.",
                embed=None,
            )
            await confirmation_msg.clear_reactions()
        except Exception as e:
